...
class AnimationController:
    def __init__(self):
        self.frames = {
            ...
            'thunder_skeleton': import_animations_from_folder('assets/FX/particles/smoke_orange', 0.25),
            'fire_skeleton': import_animations_from_folder('assets/FX/particles/smoke_orange', 0.25),
